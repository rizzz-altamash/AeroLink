...
//       {/* Animated Background */}
//       <div className="fixed inset-0 z-0">
//         <div className="absolute inset-0 bg-[linear-gradient(to_right,#dc262615_1px,transparent_1px),linear-gradient(to_bottom,#dc262615_1px,transparent_1px)] bg-[size:4rem_4rem]"></div>
//         <div className="absolute inset-0 bg-gradient-to-br from-red-950/30 via-gray-950 to-rose-950/30"></div>
...
//         {/* Floating Elements */}
//         <div className="absolute top-20 right-20 animate-float">
//           <DroneIcon className="w-32 h-32 text-red-500/10" />
//         </div>
//         <div className="absolute bottom-20 left-20 animate-float-delayed">
//           <MedicalIcon className="w-40 h-40 text-rose-500/10" />
//         </div>

//         {/* Animated Pulse Rings */}
//         <div className="absolute top-1/3 left-1/4">
//           <div className="w-64 h-64 rounded-full border border-red-500/10 animate-pulse-slow"></div>
//           <div className="w-64 h-64 rounded-full border border-red-500/10 animate-pulse-slow animation-delay-1000 absolute inset-0"></div>
//         </div>
//       </div>

//       {/* Navigation */}
//       <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
//         isScrolled ? 'bg-gray-900/90 backdrop-blur-xl border-b border-red-500/20' : ''
//       }`}>
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex items-center justify-between h-16 md:h-20">
//             <div className="flex items-center gap-2">
...
//               <a href="#how-it-works" className="text-gray-300 hover:text-red-400 transition-colors">How It Works</a>
//               <a href="#benefits" className="text-gray-300 hover:text-red-400 transition-colors">Benefits</a>
...
//               <Link 
//                 href="/auth/signup"
//                 className="px-6 py-2 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-red-500/25"
//               >
//                 Get Started
//               </Link>
//             </div>
...
//                 <span className="text-red-400 text-sm font-medium">Revolutionizing Medical Deliveries</span>
//               </div>
              
//               <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
//                 The Future of 
//                 <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400"> Medical Delivery</span> 
//                 <br />is in the Air
//               </h1>
...
//                 <button 
//                   onClick={() => router.push('/auth/signup')}
//                   className="px-8 py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-red-500/25 group"
//                 >
//                   <span className="flex items-center justify-center gap-2">
//                     Start Free Trial
//                     <ArrowIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
//                   </span>
//                 </button>
//                 <button className="px-8 py-4 bg-gray-800/50 backdrop-blur hover:bg-gray-700/50 text-white font-semibold rounded-xl transition-all border border-red-500/20">
//                   Watch Demo
//                 </button>
//               </div>
...
//                 />
//                 <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-red-600 to-rose-600 rounded-2xl flex items-center justify-center shadow-lg animate-bounce-slow">
//                   <SpeedIcon className="w-12 h-12 text-white" />
//                 </div>
//                 <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-rose-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg animate-pulse">
//                   <HeartIcon className="w-10 h-10 text-white" />
//                 </div>
//               </div>
//               <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 to-rose-600/20 blur-3xl"></div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//             <h2 className="text-4xl font-bold text-white mb-4">
//               Why Choose 
//               <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400"> AeroMed</span>
//             </h2>
//             <p className="text-xl text-gray-400 max-w-3xl mx-auto">
//               Our Fixed Wing V-TOL UAV technology ensures the fastest, safest, and most reliable medical deliveries
//             </p>
...
//           {/* Connection Lines */}
//           <div className="hidden md:block relative mt-[-6rem] mb-8">
//             <div className="absolute top-1/2 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-red-500/0 via-red-500/50 to-red-500/0"></div>
//           </div>
//         </div>
//       </section>

//       {/* Medical Focus Section */}
//       <section className="relative z-10 py-20 px-4 bg-gradient-to-br from-red-950/20 via-gray-950 to-rose-950/20">
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-16 animate-fade-in-up">
//             <h2 className="text-4xl font-bold text-white mb-4">
//               Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400">Healthcare</span>
//             </h2>
//             <p className="text-xl text-gray-400 max-w-3xl mx-auto">
//               Specialized solutions for medical deliveries that save lives
//             </p>
//           </div>
...
//               description="Temperature-controlled transport for blood and plasma"
//               color="text-red-400"
...
//               icon={MedicineIcon}
//               title="Medications"
//               description="Urgent medication delivery with chain-of-custody tracking"
//               color="text-rose-400"
...
//               description="Critical organ delivery with real-time monitoring"
//               color="text-pink-400"
...
//               description="PPE, surgical tools, and emergency equipment"
//               color="text-red-400"
//               bgColor="bg-red-500/20"
//             />
//           </div>
...
//               <h2 className="text-4xl font-bold text-white mb-8">
//                 Transforming Healthcare
//                 <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400"> Logistics</span>
//               </h2>
...
//                 </div>
//               </div>
//               <div className="absolute -top-4 -right-4 w-32 h-32 bg-gradient-to-br from-red-600/20 to-rose-600/20 rounded-full blur-3xl"></div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//                 onClick={() => setActiveTestimonial(index)}
//                 className={`w-2 h-2 rounded-full transition-all ${
//                   activeTestimonial === index ? 'w-8 bg-red-500' : 'bg-gray-600'
//                 }`}
//               />
//             ))}
//           </div>
...
//       <section id="contact" className="relative z-10 py-20 px-4">
//         <div className="max-w-4xl mx-auto">
//           <div className="bg-gradient-to-br from-red-600/20 to-rose-600/20 backdrop-blur-xl rounded-3xl p-12 border border-red-500/20 text-center animate-fade-in-up">
//             <h2 className="text-4xl font-bold text-white mb-6">
//               Ready to Transform Your Medical Deliveries?
//             </h2>
//             <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
...
//               <button 
//                 onClick={() => router.push('/auth/signup?type=hospital')}
//                 className="px-8 py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-red-500/25"
//               >
//                 Start Free Trial
//               </button>
//               <button className="px-8 py-4 bg-gray-800/50 backdrop-blur hover:bg-gray-700/50 text-white font-semibold rounded-xl transition-all border border-red-500/20">
...
//               <h3 className="text-white font-semibold mb-4">Product</h3>
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Features</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Pricing</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Case Studies</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">API Docs</a></li>
//               </ul>
//             </div>
...
//               <h3 className="text-white font-semibold mb-4">Company</h3>
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">About Us</a></li>
...
//               <h3 className="text-white font-semibold mb-4">Support</h3>
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Help Center</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Contact Us</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Status</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Terms & Privacy</a></li>
//               </ul>
//             </div>
//           </div>
...
//   return (
//     <div 
//       className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-red-500/20 hover:border-red-500/30 transition-all group hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-1 animate-fade-in-up"
//       style={{ animationDelay: `${delay}ms` }}
//     >
//       <div className={`w-16 h-16 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
//         <Icon className="w-8 h-8 text-white" />
...
//     >
//       <div className="relative mb-6">
//         <div className="w-20 h-20 bg-gray-800/50 backdrop-blur rounded-2xl flex items-center justify-center mx-auto border border-red-500/20">
//           <Icon className="w-10 h-10 text-red-400" />
//         </div>
//         <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-red-600 to-rose-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
//           {number}
//         </div>
//       </div>
//       <h3 className="text-lg font-semibold text-white mb-2">{title}</h3>
...
// function MedicalCard({ icon: Icon, title, description, color, bgColor }) {
//   return (
//     <div className="bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border border-red-500/20 hover:border-red-500/30 transition-all group">
...
//         <CheckIcon className="w-6 h-6 text-red-400" />
//       </div>
//       <div>
//         <h3 className="text-lg font-semibold text-white mb-1">{title}</h3>
//         <p className="text-gray-400">{description}</p>
...
//     <div className="flex justify-between items-end">
//       <span className="text-gray-400">{label}</span>
//       <span className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400">
//         {value}
//       </span>
//     </div>
//   );
...
//     }`}>
//       <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-red-500/20">
//         <QuoteIcon className="w-12 h-12 text-red-500/20 mb-4" />
//         <p className="text-xl text-gray-300 mb-6 italic">{quote}</p>
//         <div>
//           <p className="text-white font-semibold">{author}</p>
//           <p className="text-gray-400 text-sm">{role}</p>
//           <p className="text-red-400 text-sm">{hospital}</p>
//         </div>
//       </div>
//     </div>
//   );
...
// const MedicineIcon = ({ className }) => (
//   <svg className={className} fill="currentColor" viewBox="0 0 24 24">
//     <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" />
//   </svg>
// );

// const OrganIcon = ({ className }) => (
//   <svg className={className} fill="currentColor" viewBox="0 0 24 24">
//     <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
//   </svg>
// );

// const SuppliesIcon = ({ className }) => (
//   <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
//       {/* Animated Background */}
//       <div className="fixed inset-0 z-0">
//         {/* Mixed color grid pattern */}
//         <div className="absolute inset-0 bg-[linear-gradient(to_right,#10b98115_1px,transparent_1px),linear-gradient(to_bottom,#dc262615_1px,transparent_1px)] bg-[size:4rem_4rem]"></div>
//         <div className="absolute inset-0 bg-gradient-to-br from-green-950/20 via-gray-950 to-red-950/20"></div>
        
//         {/* Animated Drone Paths with mixed colors */}
//         <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
//           <defs>
//             <path id="dronePath1" d="M0,200 Q400,100 800,200 T1600,200" />
//             <path id="dronePath2" d="M0,400 Q400,300 800,400 T1600,400" />
...
//         </div>
//         <div className="absolute bottom-20 left-20 animate-float-delayed">
//           <MedicalIcon className="w-40 h-40 text-red-500/10" />
//         </div>

//         {/* Animated Pulse Rings with mixed colors */}
//         <div className="absolute top-1/3 left-1/4">
//           <div className="w-64 h-64 rounded-full border border-green-500/10 animate-pulse-slow"></div>
//           <div className="w-64 h-64 rounded-full border border-red-500/10 animate-pulse-slow animation-delay-1000 absolute inset-0"></div>
//         </div>
//       </div>
...
//               <a href="#benefits" className="text-gray-300 hover:text-red-400 transition-colors">Benefits</a>
//               <a href="#contact" className="text-gray-300 hover:text-rose-400 transition-colors">Contact</a>
//             </div>
...
//                 <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400"> Medical Delivery</span> 
//                 <br />is in the 
//                 <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400"> Air</span>
//               </h1>
...
//                   </span>
//                 </button>
//                 <button className="px-8 py-4 bg-gray-800/50 backdrop-blur hover:bg-gray-700/50 text-white font-semibold rounded-xl transition-all border border-red-500/20 hover:border-red-500/30">
//                   Watch Demo
//                 </button>
//               </div>
...
//               <div className="flex items-center gap-8 mt-12">
//                 <div>
//                   <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">15min</p>
//                   <p className="text-gray-400 text-sm">Avg. Delivery Time</p>
//                 </div>
//                 <div className="w-px h-12 bg-gray-700"></div>
//                 <div>
//                   <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400">99.9%</p>
//                   <p className="text-gray-400 text-sm">Success Rate</p>
//                 </div>
//                 <div className="w-px h-12 bg-gray-700"></div>
//                 <div>
...
//                   <SpeedIcon className="w-12 h-12 text-white" />
//                 </div>
//                 <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-red-600 to-rose-600 rounded-2xl flex items-center justify-center shadow-lg animate-pulse">
//                   <HeartIcon className="w-10 h-10 text-white" />
//                 </div>
//               </div>
//               <div className="absolute inset-0 bg-gradient-to-br from-green-600/20 to-red-600/20 blur-3xl"></div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//           {/* Connection Lines */}
//           <div className="hidden md:block relative mt-[-6rem] mb-8">
//             <div className="absolute top-1/2 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-green-500/0 via-emerald-500/50 to-red-500/0"></div>
//           </div>
//         </div>
//       </section>

//       {/* Medical Focus Section */}
//       <section className="relative z-10 py-20 px-4 bg-gradient-to-br from-red-950/10 via-gray-950 to-green-950/10">
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-16 animate-fade-in-up">
//             <h2 className="text-4xl font-bold text-white mb-4">
//               Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-400">Healthcare</span>
...
//                 <h3 className="text-2xl font-bold text-white mb-6">By the Numbers</h3>
//                 <div className="space-y-6">
//                   <StatItem label="Deliveries Completed" value="50,000+" gradientColors="from-green-400 to-emerald-400" />
//                   <StatItem label="Partner Hospitals" value="150+" gradientColors="from-red-400 to-rose-400" />
//                   <StatItem label="Lives Impacted" value="1M+" gradientColors="from-emerald-400 to-green-400" />
//                   <StatItem label="Cities Covered" value="25" gradientColors="from-rose-400 to-red-400" />
//                 </div>
//               </div>
//               <div className="absolute -top-4 -right-4 w-32 h-32 bg-gradient-to-br from-green-600/20 to-red-600/20 rounded-full blur-3xl"></div>
//             </div>
//           </div>
//         </div>
//       </section>
...
//                 onClick={() => setActiveTestimonial(index)}
//                 className={`w-2 h-2 rounded-full transition-all ${
//                   activeTestimonial === index ? 'w-8 bg-gradient-to-r from-green-500 to-red-500' : 'bg-gray-600'
//                 }`}
//               />
//             ))}
//           </div>
...
//       <section id="contact" className="relative z-10 py-20 px-4">
//         <div className="max-w-4xl mx-auto">
//           <div className="bg-gradient-to-br from-green-600/20 via-gray-900/50 to-red-600/20 backdrop-blur-xl rounded-3xl p-12 border border-green-500/20 text-center animate-fade-in-up">
//             <h2 className="text-4xl font-bold text-white mb-6">
//               Ready to Transform Your Medical Deliveries?
//             </h2>
//             <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
...
//                 Start Free Trial
//               </button>
//               <button className="px-8 py-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-red-500/25">
//                 Schedule Demo
//               </button>
//             </div>
//             <p className="text-gray-400 text-sm mt-6">
...
//               <ul className="space-y-2">
//                 <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors text-sm">Features</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Pricing</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Case Studies</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-rose-400 transition-colors text-sm">API Docs</a></li>
//               </ul>
//             </div>
...
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Blog</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-rose-400 transition-colors text-sm">Press</a></li>
//               </ul>
//             </div>
...
//                 <li><a href="#" className="text-gray-400 hover:text-red-400 transition-colors text-sm">Status</a></li>
//                 <li><a href="#" className="text-gray-400 hover:text-rose-400 transition-colors text-sm">Terms & Privacy</a></li>
//               </ul>
//             </div>
//           </div>
...
// // Component definitions
// function FeatureCard({ icon: Icon, title, description, gradient, borderColor, delay }) {
//   return (
//     <div 
//       className={`bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border ${borderColor} hover:border-opacity-50 transition-all group hover:shadow-xl hover:shadow-current/10 hover:-translate-y-1 animate-fade-in-up`}
//       style={{ animationDelay: `${delay}ms` }}
//     >
//       <div className={`w-16 h-16 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
//         <Icon className="w-8 h-8 text-white" />
...
// function StepCard({ number, title, description, icon: Icon, gradient, delay }) {
//   return (
//     <div 
//       className="text-center animate-fade-in-up"
//       style={{ animationDelay: `${delay}ms` }}
//     >
//       <div className="relative mb-6">
//         <div className="w-20 h-20 bg-gray-800/50 backdrop-blur rounded-2xl flex items-center justify-center mx-auto border border-gray-700">
//           <Icon className="w-10 h-10 text-gray-300" />
//         </div>
//         <div className={`absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br ${gradient} rounded-full flex items-center justify-center text-white font-bold text-sm`}>
//           {number}
//         </div>
//       </div>
//       <h3 className="text-lg font-semibold text-white mb-2">{title}</h3>
...
// function MedicalCard({ icon: Icon, title, description, color, bgColor, borderColor }) {
//   return (
//     <div className={`bg-gray-900/50 backdrop-blur-xl rounded-xl p-6 border ${borderColor} hover:border-opacity-50 transition-all group`}>
//       <div className={`w-12 h-12 ${bgColor} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
//         <Icon className={`w-6 h-6 ${color}`} />
//       </div>
//       <h3 className="text-lg font-semibold text-white mb-2">{title}</h3>
...
// function BenefitItem({ title, description, iconBg, iconColor }) {
//   return (
//     <div className="flex gap-4">
...
// function StatItem({ label, value, gradientColors }) {
//   return (
//     <div className="flex justify-between items-end">
//       <span className="text-gray-400">{label}</span>
//       <span className={`text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${gradientColors}`}>
//         {value}
//       </span>
//     </div>
//   );
