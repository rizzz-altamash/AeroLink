...
export default function LandingPage() {
  ...
  const userTypes = [
    ...
    },
    {
      ...
      icon: "M6 10h4v4H6v-4zm8 0h4v4h-4v-4zM4 6h16c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z",
      features: [
      ...
      <section id="how-it-works" className="relative py-20 px-4 bg-gradient-to-br from-lime-950/20 to-emerald-950/20">
        <div className="max-w-7xl mx-auto">
          <div className="gsapTransformingHeading text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto"></p>
          </div>
            ...
            {[
              {
                ...
                description: "Our V-TOL UAV causes least carbon emission than other transportations.",
                icon: ""
              },
              {
                step: "02",
              ...
              },
              {
                step: "04",
                title: "Save Time",
                description: "V-TOL UAV delivers directly to hospitals and medicals, saving a lot of time.",
                icon: ""
              }
            ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a 
                href="https://www.facebook.com/share/1HKBT7CbJq/"
                target="_blank"
              ...
              <a 
                href="https://github.com/rizzz-altamash/AeroLink"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-lime-400 transition-colors"
              >
              ...
              <a 
                href="https://x.com/rizzz_altamash?t=gZN05h6DQszTe1p9NcGD2g&s=09"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-lime-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="https://www.linkedin.com/in/md-altamash-rizwi-1865b2322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-lime-400 transition-colors">
              ...
              <a 
                href="https://instagram.com/rizzz_altamash/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-lime-400 transition-colors">
                <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24">
