...
//     // Recipient details
//     recipientType: 'hospital', // hospital or individual
//     recipientHospitalId: '',
//     recipientUserId: '',
//     recipientName: '',
//     recipientPhone: '',
...
//     try {
//       const res = await fetch('/api/hospitals/verified');
//       if (res.ok) {
...
//         // if (!formData.recipientHospitalId) newErrors.recipientHospitalId = 'Please select a hospital';
//       } else {
...
//         if (!formData.recipientAddress) newErrors.recipientAddress = 'Address is required';
//       }
//     }
...
//   const searchRecipientByPhone = async () => {
//     if (!formData.recipientPhone || formData.recipientPhone.length < 10) return;
    
//     setSearchingRecipient(true);
//     try {
//       const res = await fetch(`/api/users/search?phone=${formData.recipientPhone}`);
//       if (res.ok) {
...
//     setLoading(true);
//     try {
//       // Get sender coordinates (hospital or user location)
//       const senderHospital = hospitals.find(h => h._id === session.user.hospitalId);
//       const senderCoordinates = senderHospital?.address?.coordinates?.coordinates || [0, 0];
      
//       // Get recipient coordinates
//       let recipientCoordinates = [0, 0];
//       if (formData.recipientType === 'hospital') {
//         const recipientHospital = hospitals.find(h => h._id === formData.recipientHospitalId);
//         recipientCoordinates = recipientHospital?.address?.coordinates?.coordinates || [0, 0];
//       } else if (formData.recipientCoordinates) {
//         recipientCoordinates = formData.recipientCoordinates;
//       }
...
//         // Recipient info
//         recipientHospitalId: formData.recipientType === 'hospital' ? formData.recipientHospitalId : undefined,
//         recipientUserId: formData.recipientUserId || undefined,
...
//               <p className="text-gray-400">Fill in the details to request a drone delivery</p>
//             </div>
...
//                     </label>
//                     <select
//                       name="recipientHospitalId"
//                       value={formData.recipientHospitalId}
//                       onChange={handleInputChange}
//                       className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
//                     >
...
//                       ))}
//                     </select>
//                     {errors.recipientHospitalId && (
//                       <p className="mt-1 text-sm text-red-400">{errors.recipientHospitalId}</p>
//                     )}
//                   </div>
//                 ) : (
//                   <>
...
//                   <h3 className="text-lg font-semibold text-white mb-4">Delivery Summary</h3>
...
//                       <p className="text-gray-400 text-sm mb-2">Delivery Route</p>
//                       <div className="flex items-center gap-4">
//                         <div className="flex-1">
//                           <p className="text-white font-medium">From</p>
//                           <p className="text-gray-300 text-sm">{session?.user?.hospitalName || 'Your Hospital'}</p>
//                         </div>
...
//                             {formData.recipientType === 'hospital' 
//                               ? hospitals.find(h => h._id === formData.recipientHospitalId)?.name
...
//                 {/* Estimated Cost */}
//                 <div className="bg-gradient-to-r from-red-600/10 to-rose-600/10 rounded-xl p-6 border border-red-500/20">
...
//                       <p className="text-xl font-semibold text-red-400">{currentUrgency.estimatedTime}</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
