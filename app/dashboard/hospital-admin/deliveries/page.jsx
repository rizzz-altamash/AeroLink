        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8">
          ...
          <div className="relative mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">Hospital Deliveries</h1>
                <p className="text-sm sm:text-base text-gray-400">View and manage all deliveries for your hospital</p>
              </div>
          ...
          {showFilters && (
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-red-500/20 mb-4 sm:mb-6 animate-fade-in-up">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
                ...
                <div className="col-span-1">
                  <label className="block text-xs sm:text-sm font-medium text-gray-400 mb-1 sm:mb-2">Direction</label>
                  <select
                    value={filters.direction}
                    onChange={(e) => handleFilterChange('direction', e.target.value)}
                    className="w-full px-3 sm:px-4 py-2 bg-gray-800/50 border border-gray-700 rounded-xl text-white focus:ring-2 focus:ring-red-500 text-sm sm:text-base"
                    ...
                    <table className="min-w-full">
                      <thead>
                        <tr className="text-left border-b border-gray-800">
                          ...
                          <th className="pb-2 sm:pb-3 px-3 text-xs sm:text-sm font-medium text-gray-400 whitespace-nowrap">Direction</th>
                          <th className="pb-2 sm:pb-3 px-3 text-xs sm:text-sm font-medium text-gray-400 whitespace-nowrap">Urgency</th>
                          <th className="pb-2 sm:pb-3 px-3 text-xs sm:text-sm font-medium text-gray-400 whitespace-nowrap">Requested By</th>
                        ...
                        {deliveries.length === 0 ? (
                          ...
                          deliveries.map((delivery) => (
                            <tr key={delivery._id} className="hover:bg-gray-800/50 transition-colors">
                              ...
                              <td className="py-2 sm:py-3 px-3">
                                <span className={`px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${urgencyColors[delivery.package?.urgency] || urgencyColors.routine}`}>
                                  {delivery.package?.urgency}
                                </span>
                              </td>
                              <td className="py-2 sm:py-3 px-3">
                                <span className="text-gray-300 text-xs sm:text-sm whitespace-nowrap">{delivery.requestedBy?.name || 'Unknown'}</span>
                              </td>
                              <td className="py-2 sm:py-3 px-3">
