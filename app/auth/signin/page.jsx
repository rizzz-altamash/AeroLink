  ...
  return (
    <div className="min-h-screen bg-gray-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Animated Drone Paths */}
        <svg className="hidden md:block absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <path id="dronePath1" d="M0,200 Q400,100 800,200 T1600,200" />
            <path id="dronePath2" d="M0,400 Q400,300 800,400 T1600,400" />
          </defs>
        ...
        {/* Floating Drone Icons */}
        <div className="absolute top-10 sm:top-20 left-10 sm:left-20 animate-float hidden md:block">
          <svg className="w-16 sm:w-24 h-16 sm:h-24 text-green-500/10" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
            <path d="M8 12l2-2 2 2 2-2 2 2-4 4z"/>
          </svg>
        </div>
        <div className="absolute bottom-20 sm:bottom-32 right-10 sm:right-20 animate-float-delayed hidden sm:block">
          <svg className="w-20 sm:w-32 h-20 sm:h-32 text-emerald-500/10" viewBox="0 0 24 24" fill="currentColor">
            <path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z"/>
          </svg>
        </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden lg:block">
          <div className="w-64 sm:w-96 h-64 sm:h-96 rounded-full border border-green-500/10 animate-radar"></div>
          <div className="w-64 sm:w-96 h-64 sm:h-96 rounded-full border border-green-500/10 animate-radar animation-delay-1000"></div>
          <div className="w-64 sm:w-96 h-64 sm:h-96 rounded-full border border-green-500/10 animate-radar animation-delay-2000"></div>
        </div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="inline-flex items-center justify-center w-16 sm:w-20 md:w-24 h-16 sm:h-20 md:h-24 bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl sm:rounded-2xl mb-3 sm:mb-4 shadow-2xl shadow-green-500/25 relative">
              <svg className="w-10 sm:w-12 md:w-15 h-10 sm:h-12 md:h-15 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" />
              </svg>
              {/* Rotating Ring */}
              <div className="absolute inset-0 rounded-xl sm:rounded-2xl border-2 border-green-400/20 animate-spin-slow"></div>
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">Welcome Back</h1>
            <p className="text-green-400/80 text-sm sm:text-base">Sign In</p> {/* Access your drone delivery dashboard */}
          </div>

          {/* Form */}
          <form onSubmit={handleSubmit} className="bg-gray-900/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 border border-green-500/10">
            {error && (
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-green-400 mb-1.5 sm:mb-2">
                  Email Address
                </label>
                <div className="relative">
                  <input
              ...
              <div>
                <label htmlFor="password" className="block text-xs sm:text-sm font-medium text-green-400 mb-1.5 sm:mb-2">
                  Password
                </label>
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setPassword(e.target.value)}
                    required
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pl-10 sm:pl-12 pr-10 sm:pr-12 bg-gray-800/50 backdrop-blur border border-green-500/20 rounded-lg sm:rounded-xl text-white focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-sm sm:text-base"
                    placeholder="••••••••"
                  />
                  <svg className="w-4 sm:w-5 h-4 sm:h-5 text-green-500/50 absolute left-3 sm:left-4 top-2.5 sm:top-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  ...
                  <button
                    ...
                    className="absolute right-3 sm:right-4 top-2.5 sm:top-3.5 text-green-500/50 hover:text-green-500/70 transition-colors"
                  >
                    {showPassword ? (
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                ...
                <Link href="/auth/forgot-password" className="text-xs sm:text-sm text-green-400 hover:text-green-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
