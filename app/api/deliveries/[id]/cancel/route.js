...
//     // Notify hospital admin if delivery was pending approval or approved
//     if (['pending_approval', 'approved', 'assigned'].includes(previousStatus)) {
...
//             message: `Delivery ${delivery.orderId} has been cancelled by ${cancelledBy.name}`,
//             data: {
