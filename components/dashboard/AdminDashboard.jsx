...
//   const assignPilot = async (deliveryId, pilotId, droneId) => {
//     try {
//       const res = await fetch(`/api/admin/deliveries/${deliveryId}/assign-pilot`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
//         body: JSON.stringify({ pilotId, droneId })
//       });
...
//           onAssign={() => assignPilot(selectedDelivery._id, selectedPilot, selectedDrone)}
//           onClose={() => {
//             setShowAssignmentModal(false);
//             setSelectedDelivery(null);
//             setSelectedPilot('');
...
//   onClose 
// }) {
//   const canAssign = selectedPilot && selectedDrone;
...
//         {/* Drone Selection */}
//         <div className="mb-6">
//           <h3 className="text-lg font-semibold text-white mb-3">Select Drone</h3>
//           {drones.length === 0 ? (
//             <p className="text-gray-500">No drones available for this delivery</p>
//           ) : (
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
//               {drones.map((drone) => (
//                 <div
...
//                           Max payload: {drone.specifications?.maxPayload}g
//                         </p>
//                         <p className="text-gray-500 text-xs">
