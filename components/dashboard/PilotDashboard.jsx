...
//         {/* Weather Widget */}
//         <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/10">
...
//               <div className={`mt-4 p-3 rounded-lg ${weatherData.flyable ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
...
//       {/* Assigned Deliveries */}
//       <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/10 mb-8">
...
//   return (
//     <div className={`bg-gray-800/50 rounded-xl p-5 border-l-4 ${borderColor} hover:bg-gray-800/70 transition-all`}>
